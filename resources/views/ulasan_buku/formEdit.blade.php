            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="pd-10 pd-sm-20 bg-gray-100">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="row row-xs align-items-center mg-b-20">
                                        ...
                                        <div class="col-md-9 mg-t-5 mg-md-t-0">
                                            <select class="form-control select2" name="user_id">
                                                @php
                                                $ulasanbuku = DB::table('users')->select('*')->orderBy('username','ASC')->get();
                                                @endphp
                                                <option value="">=== pilih ===</option>
                                                @foreach($ulasanbuku as $key => $val)
                                    ...
                                    <div class="row row-xs align-items-center mg-b-20">
                                        ...
                                        <div class="col-md-9 mg-t-5 mg-md-t-0">
                                            <input class="form-control" placeholder="" type="date" name="buku" value="{{old('buku')}}">
                                        </div>
                                    </div> -->
                                    <div class="row row-xs align-items-center mg-b-20">
                                        <div class="col-md-3">
                                        ...
                                        <div class="col-md-9 mg-t-5 mg-md-t-0">
                                            <input class="form-control" placeholder="" type="text" name="ulasan" value="{{old('ulasan')}}">
                                        </div>
                                    </div>
                                    <div class="row row-xs align-items-center mg-b-20">
                                        <div class="col-md-3">
                                        ...
                                        <div class="col-md-9 mg-t-5 mg-md-t-0">
                                            <input class="form-control" placeholder="" type="text" name="rating" value="{{old('rating')}}">
                                        </div>
                                    </div>
                        ...
                        <a href="{{route('ulasan_buku')}}" class="btn btn-secondary pd-x-30 mg-t-5">
