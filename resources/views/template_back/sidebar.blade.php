...
<div class="sticky">
    <aside class="app-sidebar sidebar-scroll">
        ...
        <div class="main-sidemenu">
            ...
            <ul class="side-menu ">
                <li class="slide">
                    <a class="side-menu__item {{ request()->is('buku')? 'active':'' }}" href="{{route('dashboard') }}"><i class="side-menu__icon fe fe-airplay"></i><span class="side-menu__label">Dashboard</span></a>
                </li>
            </ul>
